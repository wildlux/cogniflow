...
class MainWindow(QMainWindow):
    ...
    def create_tools_tabs(self):
        """Crea il widget con lista verticale a sinistra e contenuto a destra"""
        from PyQt6.QtWidgets import QSplitter, QListWidget, QStackedWidget, QVBoxLayout, QWidget
        ...
        # Lista verticale a sinistra
        self.tools_list = QListWidget()
        self.tools_list.setMaximumWidth(150)  # Larghezza fissa per la lista
        ...
        self.tools_list.addItem("🎤 Trascrizione")
        self.tools_list.addItem("🧠 AI & Media")
        self.tools_list.addItem("📚 Materie")
        self.tools_list.addItem("🛠️ Utilità")
        self.tools_list.addItem("🔌 IoT")
        ...
        # Connetti la selezione della lista al cambio di contenuto
        self.tools_list.currentRowChanged.connect(self.tools_stack.setCurrentIndex)

        # Seleziona il primo elemento per default
        self.tools_list.setCurrentRow(0)

        # Aggiungi al layout principale
        main_layout.addWidget(self.tools_list)
