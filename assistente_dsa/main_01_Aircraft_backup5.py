...
class MainWindow(QMainWindow):
    ...
    def create_unified_tools_section_content(self):
        ...
        layout.addWidget(self.pensierini_input_section)
    ...
    def create_tools_tabs(self):
        ...
        grid_container.setMaximumWidth(200)  # Larghezza aumentata per 2 colonne
    ...
    def setup_ui(self):
        ...
        # Spazio tra click_status_label e il resto
        ...
        # Label per informazioni di stato (data etc.) in basso a destra
