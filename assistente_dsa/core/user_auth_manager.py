...
class User:
    ...
    def __init__(self, id, username, full_name, email, group_id, is_active, created_at, last_login=None):
        self.id = id
...
class UserAuthManager:
    ...
    def _create_default_groups(self):
        ...
        with sqlite3.connect(self.db_path) as conn:
            ...
            for group in default_groups:
                ...
                cursor.execute("SELECT id FROM user_groups WHERE name = ?", (group["name"],))
    ...
    def create_user(self, username: str, password: str, full_name: str, email: str, group_name: str = "Student") -> bool:
        ...
        try:
            with sqlite3.connect(self.db_path) as conn:
                ...
                cursor.execute("SELECT id FROM user_groups WHERE name = ?", (group_name,))
                ...
                cursor.execute('''
                    ...
                    VALUES (?, ?, ?, ?, ?, ?)
                ''', (username, password_hash, full_name, email, group_id, datetime.now().isoformat()))
    ...
    def authenticate_user(self, username: str, password: str) -> Optional[User]:
        ...
        try:
            with sqlite3.connect(self.db_path) as conn:
                ...
                user_id, db_username, password_hash, full_name, email, group_id, is_active, created_at, last_login, login_attempts, locked_until = row
    ...
    def get_user_permissions(self, user: User) -> Dict[str, bool]:
        ...
        try:
            with sqlite3.connect(self.db_path) as conn:
                ...
                cursor.execute("SELECT permissions FROM user_groups WHERE id = ?", (user.group_id,))
                row = cursor.fetchone()
                if row:
    ...
    def create_default_admin(self):
        ...
        if success:
            ...
            print("⚠️  IMPORTANTE: Cambia la password predefinita dopo il primo accesso!")
        else:
